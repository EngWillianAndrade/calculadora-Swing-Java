...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		//Linha 3
		adicionarBotao("6", COR_CINZA_CLARO, c, 0, 3);
		adicionarBotao("5", COR_CINZA_CLARO, c, 1, 3);
		adicionarBotao("4", COR_CINZA_CLARO, c, 2, 3);
		adicionarBotao("-", COR_LARANJA, c, 3, 3);
		
		//Linha 4
		adicionarBotao("3", COR_CINZA_CLARO, c, 0, 4);
		adicionarBotao("2", COR_CINZA_CLARO, c, 1, 4);
		adicionarBotao("1", COR_CINZA_CLARO, c, 2, 4);
